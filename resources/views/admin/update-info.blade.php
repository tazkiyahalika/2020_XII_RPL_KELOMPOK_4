...
@section('content')
                ...
                <form enctype="multipart/form-data" action="{{ url('/admin/info/update/'.$extracurricular->info_id) }}" method="POST">
                ...
                <div class="card-body">
                 ...
                 <!--  -->
                      ...
                      <label>Nama Ekstrakulikuler</label>
                        <select class="form-control" name="info_esc_id" required="required" placeholder="Extrakulikuler">
                      <option value="---pilih nama ekstrakulikuler---">---pilih nama ekstrakulikuler---</option>
                      @foreach($extracurricular as $extracurricular)
                      <option value='{{ $extracurricular->info_esc_id }}'>{{ $extracurricular->esc_name }}</option>
                      @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                     <label>Nama Pembina</label>
                        <select class="form-control" name="info_usr_id" required="required" placeholder="Extrakulikuler">
